    ...
    <div className="bg-background min-h-screen flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <main className="w-full max-w-md bg-card border border-border rounded-xl shadow-sm relative z-10 flex flex-col p-8 md:p-12 items-center text-center">
        ...
        <div className="w-full flex flex-col items-center gap-6">
          <Button asChild variant="outline" className="w-full h-12 flex items-center justify-center gap-3 bg-secondary/30 hover:bg-secondary/60 text-foreground font-medium text-sm transition-all duration-200 active:scale-[0.98]">
          ...
          <p className="text-sm text-muted-foreground/80 text-center max-w-[280px]">
            Only pre-authorized USSTM members can sign in.
          </p>
        </div>
      </main>
    </div>
